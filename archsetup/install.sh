...
install_pkgs=(
    ...
    foot nvtop htop inxi fastfetch onefetch newsboat neovim tmux asciinema trash-cli wget yt-dlp aria2
    ...
    lua python uv python-black stylua pyright texlab bash-language-server shfmt ollama
)
